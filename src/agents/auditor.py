    ...
    def analyze(self, target_dir: str) -> Dict:
        ...
        try:
            ...
            for filename in python_files:
                ...
                # Logger le résultat pour ce fichier
                log_experiment(
                ...
                # Afficher le nombre de problèmes pour ce fichier
                print(f" Analyse terminée pour {filename} : {len(file_issues)} problème(s) détecté(s)")
